...
{   $sql1="SELECT * FROM product WHERE vemail='$em'";
            ...
            <div class="card-body-right border rounded" style="display:table-cell">
              ...
              <p class="card-text text-dark">Price: Rs.<?php echo $data['price']."<br>";?></p>
			   ...
			   <?php
                  ...
                  if($ka1==1)
                  {
                    ?><a href="#" onclick="return checkchange()"><button class="btn btn-primary rounded disabled" style="float:left;width:100%;">Change Product</button></a>
                  <?php 
				 }
				  else
                  {
                    ?><a href="vendor_change_pro.php?id=<?php echo $data['productid']; ?>"><button class="btn btn-primary rounded" style="float:left;width:100%;">Change Product</button></a>
                  <?php
                  }
    ...
    <ul class="pagination">
    <a href="vendor_changepro.php?page=<?php if($page!=1){$g=$page-1;} else{$g=1;} echo $g; ?>"><button class="btn btn-danger">&laquo;Previous</button></a>
    <a href="vendor_changepro.php?page=1"><button class="btn btn-primary">First</button></a>
    <a href="vendor_changepro.php?page=<?php echo $x; ?>"><button class="btn btn-primary">Last</button></a>
    ...
    for($i=1;$i<=$x;$i++)
    {
        if($page==$i)
        {
        ?><a href="vendor_changepro.php?page=<?php echo $i; ?>" style="text-decoration:none; font-size:20px;" class="active"><?php echo $i." ";?></a>
        <?php
        }
        else{
            ?><a href="vendor_changepro.php?page=<?php echo $i; ?>" style="text-decoration:none; font-size:20px;"><?php echo $i." ";?></a>
            <?php
        }
    ...
    <a href="vendor_changepro.php?page=<?php if($page!=$x){$o=$page+1;}else{ $o=$x;} echo $o; ?>"><button class="btn btn-danger">Next&raquo;</button</a>
    </ul>
...
function checkchange(){
	return alert("Product cannot be changed");
}
</script>
</body>
</html>
