...
if($userprofile==true)
{
    ...
    $sql1="SELECT * FROM buyproduct WHERE delivered='1'";
    ...
    $sql="SELECT * FROM buyproduct WHERE delivered='1' LIMIT $page1,$k";
    ...
    <ul class="pagination">
    <a href="product_sold.php?page=<?php if($page!=1){$g=$page-1;} else{$g=1;} echo $g; ?>"><button class="btn btn-danger">&laquo;Previous</button></a>
    <a href="product_sold.php?page=1"><button class="btn btn-primary">First</button></a>
    <a href="product_sold.php?page=<?php echo $x; ?>"><button class="btn btn-primary">Last</button></a>
    <a href="product_sold.php?page=<?php if($page!=$x){$o=$page+1;}else{ $o=$x;} echo $o; ?>"><button class="btn btn-danger">Next&raquo;</button</a>
    </ul>
