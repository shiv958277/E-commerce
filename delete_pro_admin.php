...
if($userprofile==true)
{
        ...
        while($data=mysqli_fetch_array($result))
        {
            ...
            <div class="card-body-right border rounded" style="display:table-cell">
			 ...
			 <?php
                  ...
                  {
                    ?><a href="delete_pro_confirm.php?id=<?php echo $data['productid']; ?>"onclick="return confirmdelete()"><button class="btn btn-primary rounded" style="float:left;width:100%;">Delete Product</button></a>
                  <?php
                  }
    ...
    <ul class="pagination">
    <a href="delete_pro_admin.php?page=<?php if($page!=1){$g=$page-1;} else{$g=1;} echo $g; ?>"><button class="btn btn-danger">&laquo;Previous</button></a>
    <a href="delete_pro_admin.php?page=1"><button class="btn btn-primary">First</button></a>
    <a href="delete_pro_admin.php?page=<?php echo $x; ?>"><button class="btn btn-primary">Last</button></a>
    <a href="delete_pro_admin.php?page=<?php if($page!=$x){$o=$page+1;}else{ $o=$x;} echo $o; ?>"><button class="btn btn-danger">Next&raquo;</button</a>
    </ul>
    <script>
