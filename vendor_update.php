...
if($email==true)
{
    ...
    <body class="bg-light">
    <?php
    $ql="SELECT * FROM vendor WHERE email='$email'";
    ...
    <div class="container">
    <a href="vendor_settings.php"><button  class="btn btn-secondary"style="width:100%;">Go-back</button></a>
    </div>
    <?php
    if($_POST['submit'])
    {
        ...
        $query="UPDATE vendor SET NAME='$name',USERNAME='$username',ADDRESS='$address' WHERE EMAIL='$email'";
        ...
        if($data)
        {
            ...
            <?php
            header("Refresh: 2; url=vendor_update.php");
        }
        else	
        {
            ?>
